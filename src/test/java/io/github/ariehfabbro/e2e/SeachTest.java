...
public final class SeachTest extends BaseTest {

    private static final String FILE_PATH = "search.json";

    @DataProvider(name = "searchData")
    public Object[][] getSearchData(final Method testMethod) {
    ...
    public void testCorrectUserNameAndCorrectPassword(final SearchDto data) {
        ResultsPage resultsPage = searchPage.DoASearch(data.getSearchText());
